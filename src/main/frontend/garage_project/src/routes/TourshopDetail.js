...
//         try {
//             const result = await axios.get(`${props.javaServer}tourshop/svshopdetail/${code}`, {
...
//         try{
//             axios.post(props.javaServer+'tourshop/sveditreview/'+code,{boarder_code:resultQue.board.boarder_code,content:commentTexts[code],user_id:props.loginId},{withCredentials:true})
//                 .then((res)=>{
//                     if (res.data.result) {
//                         alert("수정완료");
//                         editComment(code)
